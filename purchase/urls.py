...
urlpatterns = [
    ...
    path("<int:pk>/actual-spend/refund/", views.pr_record_refund, name="pr_record_refund"),
    path("<int:pk>/actual-spend/attachment/upload/", views.pr_actual_attachment_upload, name="pr_actual_attachment_upload"),
    path("<int:pk>/actual-spend/attachment/link/", views.pr_actual_attachment_link, name="pr_actual_attachment_link"),
    path("<int:pk>/reopen-correction/", views.pr_reopen_correction, name="pr_reopen_correction"),
