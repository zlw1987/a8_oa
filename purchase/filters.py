...
class PurchaseRequestListFilterForm(forms.Form):
    ...
    def __init__(self, *args, visible_queryset=None, **kwargs):
        ...
        status_choices = [("", "All")] + list(RequestStatus.choices)
        self.fields["status"].choices = status_choices

        visible_queryset = visible_queryset if visible_queryset is not None else None
