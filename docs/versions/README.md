...
This directory tracks major functional versions of A8 OA.

## Versions

- [V0.1 Foundation](v0.1-foundation.md): Django project foundation, accounts, departments, and base navigation.
- [V0.2 Purchase, Travel, And Approval](v0.2-purchase-travel-approval.md): purchase/travel request workflows and approval task framework.
- [V0.3 Budget And Project Ledger](v0.3-budget-project-ledger.md): project budget reservation, release, consumption, and ledger visibility.
...
- [V1.1 Phase 3 Completion Checkpoint](v1.1-phase3-completion.md): Phase 3 closeout preparation, targeted verification summary, UAT checklist, and accepted risks.
- [Current Version](current.md): latest implemented state and verification snapshot.

## Update Rule

When a new milestone lands, add a new `vX.Y-*.md` file and update this index plus `current.md`.
