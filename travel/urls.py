...
urlpatterns = [
    ...
    path("<int:pk>/actual-expense/refund/", views.tr_record_refund, name="tr_record_refund"),
    path("<int:pk>/actual-expense/attachment/upload/", views.tr_actual_attachment_upload, name="tr_actual_attachment_upload"),
    path("<int:pk>/actual-expense/attachment/link/", views.tr_actual_attachment_link, name="tr_actual_attachment_link"),
    path("<int:pk>/reopen-correction/", views.tr_reopen_correction, name="tr_reopen_correction"),
    path("<int:pk>/supplemental/create/", views.tr_create_supplemental, name="tr_create_supplemental"),
